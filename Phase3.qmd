...
Firstly, the variance of the random intercept `REF_AREA (Intercept)` is 35369.29, which is much higher than the residual variance (`Residual`) at 808.14. This suggests important differences between baseline avoidable mortality within countries even after taking into account the fact that health expenditure and social expenditure have varying effects depending on the country. This reveals how strong structural differences and different history are important to consider when looking at the difference in mortality between two countries.  
...
- `hospBeds_lag1` : The addition of 1 bed per 1,000 inhabitants last year is associated with 29 more deaths per 100,000. However, while this result is strange we can interpret this as a lack of causality between the number of hospital beds and avoidable mortality. 
...
- `OBS_VALUE_gdp` : An increase in GDP by 1 dollar (constant in 2015$US) reduces avoidable mortality by 4.33 deaths per 100,000.
...
- `OBS_VALUE_gdp` : An increase in GDP by 1 dollar (constant in 2015$US) reduces avoidable mortality by  3.37 deaths per 100,000.
...
- `OBS_VALUE_gdp` : An increase in GDP by 1 dollar (constant in 2015$US) reduces avoidable mortality by  2.81 deaths per 100,000.
...
- `pandemic` : Ceteris paribus, there was a average increase in mortality during Covid of 123 deaths per 100,000
