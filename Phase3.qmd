...
$$ Mortality_{i,t} = \gamma_{0,i} + \beta_{i,1} * mortality_{i,t-1} + \beta_{i,2} * mortality_{i,t-2} + \beta_{i,3} * health.expenditure_{i,t-1} + \beta_{i,4} * health.expenditure_{i,t-2} + \beta_{i,5} * Hospital.Beds_{i,t-1} + \beta_{i,6} * Hospital.Beds_{i,t-2} + \gamma_{i,7} * GDP.per.capita_{i,t} + \gamma_{i,8} * Unemployment_{i,t} + \gamma_{i,9} * HDI_{i,t} + \gamma_{i,10} * Life.expectancy_{i,t} $$
...
We also assume that 
- mortality (at time t-1), social expenditure and hospital beds, our explanatory variables, are fixed effects 
...
$$ Mortality_{i,t} = \gamma_{0,i} + \beta_{i,1} * mortality_{i,t-1} + \beta_{i,2} * health.expenditure_{i,t-1} + \beta_{i,3} * Hospital.Beds_{i,t-1} + \beta_{i,4} * GDP.per.capita_{i,t} + \beta_{i,5} * Unemployment_{i,t} + \beta_{i,6} * HDI_{i,t} + \beta_{i,7} * Life.expectancy_{i,t} $$
...
$$ Mortality_{i,t} = \gamma_{0,i} + \beta_{i,1} * mortality_{i,t-1} + \beta_{i,2} * social.expenditure_{i,t} + \beta_{i,3} * social.expenditure_{i,t-1} + \beta_{i,4} * health.expenditure_{i,t} + \beta_{i,5} * health.expenditure_{i,t-1} + \beta_{i,6} * Hospital.Beds_{i,t} + \beta_{i,7} * Hospital.Beds_{i,t-1} + \beta_{i,8} * GDP.per.capita_{i,t} + \beta_{i,9} * Unemployment_{i,t} + \beta_{i,10} * HDI_{i,t} + \beta_{i,11} * Life.expectancy_{i,t} $$
...
### Fourth to sixth tests

Fourth test with an additional random effect : GDP per capita (in order to try taking into account countries' richness level)

$$ Mortality_{i,t} = \gamma_{0,i} + \beta_{i,1} * mortality_{i,t-1} + \beta_{i,2} * social.expenditure_{i,t} + \beta_{i,3} * social.expenditure_{i,t-1} + \beta_{i,4} * health.expenditure_{i,t} + \beta_{i,5} * health.expenditure_{i,t-1} + \beta_{i,6} * Hospital.Beds_{i,t} + \beta_{i,7} * Hospital.Beds_{i,t-1} + \gamma_{i,8} * GDP.per.capita_{i,t} + \beta_{i,9} * Unemployment_{i,t} + \beta_{i,10} * HDI_{i,t} + \beta_{i,11} * Life.expectancy_{i,t} $$
...
$$ Mortality_{i,t} = \gamma_{0,i} + \beta_{i,1} * mortality_{i,t-1} + \beta_{i,2} * social.expenditure_{i,t} + \beta_{i,3} * social.expenditure_{i,t-1} + \beta_{i,4} * health.expenditure_{i,t} + \beta_{i,5} * health.expenditure_{i,t-1} + \beta_{i,6} * Hospital.Beds_{i,t} + \beta_{i,7} * Hospital.Beds_{i,t-1} + \beta_{i,8} * GDP.per.capita_{i,t} + \beta_{i,9} * Unemployment_{i,t} + \gamma_{i,10} * HDI_{i,t} + \beta_{i,11} * Life.expectancy_{i,t} $$
```{r}
#| message: false
#| warning: false
...
$$ Mortality_{i,t} = \gamma_{0,i} + \beta_{i,1} * mortality_{i,t-1} + \beta_{i,2} * social.expenditure_{i,t} + \beta_{i,3} * social.expenditure_{i,t-1} + \beta_{i,4} * health.expenditure_{i,t} + \beta_{i,5} * health.expenditure_{i,t-1} + \beta_{i,6} * Hospital.Beds_{i,t} + \beta_{i,7} * Hospital.Beds_{i,t-1} + \gamma_{i,8} * GDP.per.capita_{i,t} + \beta_{i,9} * Unemployment_{i,t} + \gamma_{i,10} * HDI_{i,t} + \beta_{i,11} * Life.expectancy_{i,t} $$
