...
```{r}
model_short_run <- lmer(OBS_VALUE_mortality ~ healthExp_lag1 + hospBeds_lag1 + socialExp_lag1 + OBS_VALUE_gdp + OBS_VALUE_unemp + (1 + healthExp_lag1 + socialExp_lag1 + hospBeds_lag1 | REF_AREA),
