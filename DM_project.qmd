...
Finally, the explained variables will be : 
- Avoidable mortality 
It will be used to estimate the population’s general health. 



Another method we might use to deal with differences between countries is **K clustering** on the variables with no missing values. This way we will be able to study countries with similar structures or wealth level together and compare them to other groups of countries. It will probably be more efficient than simply studying countries individually. 
